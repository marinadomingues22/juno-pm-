...
A new P0 customer transcript is uploaded or written to the "Raw Input" column in Juno.

**What they see instantly**

"Juno is reading your input" status pill appears under the input column. Empty Insights and PRD columns dim to ~40% to signal the agent is working.
